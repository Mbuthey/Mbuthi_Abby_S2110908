...
public class FetchObservationDataService extends AsyncTask<String, Void, String> {

    private WeatherFetchListener listener;

    public FetchObservationDataService(WeatherFetchListener listener) {
    ...
    protected void onPostExecute(String result) {
        ...
        if (listener != null) {
            listener.onObservationDataFetchComplete(result);
        }
    }

    public interface WeatherFetchListener {
        void onObservationDataFetchComplete(String weatherData);
    }
}
